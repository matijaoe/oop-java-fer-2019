...
public class TaxiRideRecord {
    ...
    public TaxiRideRecord(String medallion, String hackLicense, Date pickup,
                          Date dropoff, int duration, double distance, double pickupLongitude,
                          double pickupLatitude, double dropoffLongitude, double dropoffLatitude,
                          String paymentType, double fare, double surcharge, double tax,
                          double tip, double tolls, double total, int id) {
