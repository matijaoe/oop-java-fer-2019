...
public class CoachTest {
    ...
    public static final String[] PLAYER_NAMES = {"Pletikosa", "R Kovac", "Stimac", "D Simic", "Soldo", "Jarni",
        "Stanic", "Prosinecki", "N Kovac", "Suker", "Boksic"};
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ispis repke, not eligible player ne bi smio biti na popisu... "
                + "Butatista ne bi trebao biti na popisu...");
        ...
        nationalManager.pickStartingEleven();
        System.out.println(
                "Sad mu nedostaje jedan branic, broj pocetne jedanaestorice: "
                + croatia.getStartingEleven().size());
