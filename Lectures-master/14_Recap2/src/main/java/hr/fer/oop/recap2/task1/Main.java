...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //list is now: [(4, 5, 8, 9), (4, 5, 9, 2), (3, 6, 2, 7), (3, 6, 2, 1), (4, 4, 6, 5), (4, 4, 2), (3, 9)]
        System.out.println("Before: " + list);
        Collections.sort(list);
        //list is [(3, 6, 2, 1), (3, 6, 2, 7), (3, 9), (4, 4, 2), (4, 4, 6, 5), (4, 5, 8, 9), (4, 5, 9, 2)]
        ...
        Collections.sort(list);
        //[(3, 6, 2, 7), (3, 9), (4, 4, 2), (4, 4, 6, 5), (4, 5, 8, 9), (4, 5, 9, 2), (8, 6, 2, 7)]
